...
(
  ...
  LAN_ORDER     NUMBER(6, 0),
  LAN_ENABLED   NUMBER(1, 0) DEFAULT 1 NOT NULL,
  PRIMARY KEY (LAN_ID)
);
...
(
  ...
  LTR_LITERAL VARCHAR2(4000 CHAR) NOT NULL,
  LTR_LANID   NUMBER(10, 0) NOT NULL,
  PRIMARY KEY (LTR_ID)
);
...
(
  ...
  LTV_VALUE VARCHAR2(4000 CHAR) NOT NULL,
  PRIMARY KEY (LTV_ID)
);
