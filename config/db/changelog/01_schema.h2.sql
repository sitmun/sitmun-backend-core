...
ALTER TABLE STM_APP_TREE
  ADD CONSTRAINT STM_ATR_PK PRIMARY KEY (ATR_ID);
...
(
  ...
  LTR_LITERAL VARCHAR(1048576) NOT NULL,
  LTR_LANID   INTEGER        NOT NULL
);
...
(
  ...
  LTV_VALUE VARCHAR(1048576) NOT NULL
);
