...
import org.sitmun.common.types.codelist.CodeListValidator;
...
class SpatialReferenceSystemTest extends BaseTest {
  ...
  @BeforeEach
  public void mocks() {
    when(repository.existsByCodeListNameAndValue(any(String.class), any(String.class))).thenReturn(true);
  }
