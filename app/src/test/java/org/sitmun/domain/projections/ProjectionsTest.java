...
public class ProjectionsTest {
  ...
  public void taskAvailabilityProjectionView() throws Exception {
    mvc.perform(MockMvcRequestBuilders.get(URIConstants.TASK_AVAILABILITY_PROJECTION_VIEW, 1)
  ...
  public void backgroundProjectionView() throws Exception {
    mvc.perform(MockMvcRequestBuilders.get(URIConstants.BACKGROUNDS_URI_PROJECTION_VIEW)
        .with(SecurityMockMvcRequestPostProcessors.user(Fixtures.admin())))
      .andExpect(status().isOk())
  ...
  public void treeNodesProjectionView() throws Exception {
    mvc.perform(MockMvcRequestBuilders.get(URIConstants.TREE_NODE_URI_PROJECTION, 288)
        .with(SecurityMockMvcRequestPostProcessors.user(Fixtures.admin())))
      .andExpect(status().isOk())
    ...
    mvc.perform(MockMvcRequestBuilders.get(URIConstants.TREE_NODE_URI_PROJECTION, 2546)
        .with(SecurityMockMvcRequestPostProcessors.user(Fixtures.admin())))
      .andExpect(status().isOk())
  ...
  public void translationProjectionView() throws Exception {
    mvc.perform(MockMvcRequestBuilders.get(URIConstants.TRANSLATION_URI_PROJECTION, 301001)
        .with(SecurityMockMvcRequestPostProcessors.user(Fixtures.admin())))
      .andExpect(status().isOk())
  ...
  public void permissionsProjectionView() throws Exception {
    mvc.perform(MockMvcRequestBuilders.get(URIConstants.CARTOGRAPHY_URI_PERMISSION_URI_PROJECTION, 90)
        .with(SecurityMockMvcRequestPostProcessors.user(Fixtures.admin())))
      .andExpect(status().isOk())
  ...
  public void permissionsProjectionView2() throws Exception {
    mvc.perform(MockMvcRequestBuilders.get(URIConstants.BACKGROUND_URI_CARTOGRAPHY_GROUP_PROJECTION, 2)
        .with(SecurityMockMvcRequestPostProcessors.user(Fixtures.admin())))
      .andExpect(status().isOk())
