...
public interface CartographySpatialSelectionParameterRepository
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.CartographySpatialSelectionParameter','administration') or hasPermission(#entityId, 'org.sitmun.domain.Cartography', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.CartographySpatialSelectionParameter','administration') or hasPermission(#entityId, 'org.sitmun.domain.Cartography', 'read')")
  @NonNull
