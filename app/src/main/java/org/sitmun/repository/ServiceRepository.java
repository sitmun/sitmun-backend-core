...
public interface ServiceRepository extends PagingAndSortingRepository<Service, Integer> {
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.Service','administration') or hasPermission(#entityId, 'org.sitmun.domain.Service', 'delete')")
  @NonNull
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.Service','administration') or hasPermission(#entityId, 'org.sitmun.domain.Service', 'read')")
  @NonNull
