...
public interface ApplicationBackgroundRepository
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.ApplicationBackground','administration') or hasPermission(#entityId, 'org.sitmun.domain.ApplicationBackground', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.ApplicationBackground','administration') or hasPermission(#entityId, 'org.sitmun.domain.ApplicationBackground', 'read')")
  @NonNull
