...
public interface CartographyStyleRepository
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.CartographyStyle','administration') or hasPermission(#entityId, 'org.sitmun.domain.Cartography', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.CartographyStyle','administration') or hasPermission(#entityId, 'org.sitmun.domain.Cartography', 'read')")
  @NonNull
