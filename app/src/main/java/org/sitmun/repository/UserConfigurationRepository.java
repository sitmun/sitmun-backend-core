...
import org.sitmun.domain.QUserConfiguration;
...
public interface UserConfigurationRepository extends
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'administration') or hasPermission(#entityId, 'org.sitmun.domain.UserConfiguration', 'delete')")
