...
public interface CartographyFilterRepository
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.CartographyFilter','administration') or hasPermission(#entityId, 'org.sitmun.domain.Cartography', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.CartographyFilter','administration') or hasPermission(#entityId, 'org.sitmun.domain.Cartography', 'read')")
  @NonNull
