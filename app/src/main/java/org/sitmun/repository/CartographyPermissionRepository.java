...
public interface CartographyPermissionRepository extends
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.CartographyPermission','administration') or hasPermission(#entityId, 'org.sitmun.domain.CartographyPermission', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.CartographyPermission','administration') or hasPermission(#entityId, 'org.sitmun.domain.CartographyPermission', 'read')")
  @NonNull
