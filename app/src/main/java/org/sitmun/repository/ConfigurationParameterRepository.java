...
public interface ConfigurationParameterRepository
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.ApplicationParameter','administration') or hasPermission(#entityId, 'org.sitmun.domain.ConfigurationParameter', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.ConfigurationParameter','administration') or hasPermission(#entityId, 'org.sitmun.domain.ConfigurationParameter', 'read')")
  @NonNull
