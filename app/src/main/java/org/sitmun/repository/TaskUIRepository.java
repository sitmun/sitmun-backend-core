...
public interface TaskUIRepository extends PagingAndSortingRepository<TaskUI, Integer> {
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.TaskUI','administration') or hasPermission(#entityId, 'org.sitmun.domain.TaskUI', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.TaskUI','administration') or hasPermission(#entityId, 'org.sitmun.domain.TaskUI', 'read')")
  @NonNull
