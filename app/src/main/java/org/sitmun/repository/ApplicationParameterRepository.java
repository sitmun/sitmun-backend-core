...
public interface ApplicationParameterRepository
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.ApplicationParameter','administration') or hasPermission(#entityId, 'org.sitmun.domain.ApplicationParameter', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.ApplicationParameter','administration') or hasPermission(#entityId, 'org.sitmun.domain.ApplicationParameter', 'read')")
  @NonNull
