...
public interface TaskRelationRepository extends
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.TaskRelation','administration') or hasPermission(#entityId, 'org.sitmun.domain.TaskRelation', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.TaskRelation','administration') or hasPermission(#entityId, 'org.sitmun.domain.TaskRelation', 'read')")
  @NonNull
