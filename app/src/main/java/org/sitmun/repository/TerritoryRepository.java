...
public interface TerritoryRepository extends PagingAndSortingRepository<Territory, Integer> {
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.Territory','administration') or hasPermission(#entityId, 'org.sitmun.domain.Territory', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.Territory','administration') or hasPermission(#entityId, 'org.sitmun.domain.Territory', 'read')")
  @NonNull
