...
public interface TaskParameterRepository extends
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.TaskParameter','administration') or hasPermission(#entityId, 'org.sitmun.domain.TaskParameter', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.TaskParameter','administration') or hasPermission(#entityId, 'org.sitmun.domain.TaskParameter', 'read')")
  @NonNull
