...
public interface TaskTypeRepository extends PagingAndSortingRepository<TaskType, Integer> {
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.TaskType','administration') or hasPermission(#entityId, 'org.sitmun.domain.TaskType', 'delete')")
  ...
  @Override
  @PreAuthorize("hasPermission(#entityId, 'org.sitmun.domain.TaskType','administration') or hasPermission(#entityId, 'org.sitmun.domain.TaskType', 'read')")
  @NonNull
