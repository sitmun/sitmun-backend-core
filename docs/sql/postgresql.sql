...
drop
constraint STM_APA_FK_ARB;

alter table STM_APPARB
drop
constraint STM_APA_FK_APP;

alter table STM_APPFON
drop
constraint STM_APF_FK_APP;

alter table STM_APPFON
drop
constraint STM_APF_FK_FON;

alter table STM_APPROL
drop
constraint STM_APR_FK_ROL;

alter table STM_APPROL
drop
constraint STM_APR_FK_APP;

alter table STM_APPS
drop
constraint STM_APP_FK_GCA;

alter table STM_ARBOLNOD
drop
constraint STM_ARN_FK_CAR;

alter table STM_ARBOLNOD
drop
constraint STM_ARN_FK_ARN;

alter table STM_ARBOLNOD
drop
constraint STM_ARN_FK_ARB;

alter table STM_ARBROL
drop
constraint STM_ARR_FK_ROL;

alter table STM_ARBROL
drop
constraint STM_ARR_FK_ARB;

alter table STM_CARGO
drop
constraint STM_CGO_FK_TER;

alter table STM_CARGO
drop
constraint STM_CGO_FK_USU;

alter table STM_CARTO
drop
constraint STM_CAR_FK_CON;

alter table STM_CARTO
drop
constraint STM_CAR_FK_SERSEL;

alter table STM_CARTO
drop
constraint STM_CAR_FK_SER;

alter table STM_DISPCARTO
drop
constraint STM_DCA_FK_CAR;

alter table STM_DISPCARTO
drop
constraint STM_DCA_FK_TER;

alter table STM_DISPTAREA
drop
constraint STM_DTA_FK_TAR;

alter table STM_DISPTAREA
drop
constraint STM_DTA_FK_TER;

alter table STM_ETERRIT
drop
constraint STM_TER_FK_TGR;

alter table STM_FONDO
drop
constraint STM_FON_FK_GCA;

alter table STM_GCACAR
drop
constraint STM_GCC_FK_CAR;

alter table STM_GCACAR
drop
constraint STM_GCC_FK_GCA;

alter table STM_GRPTER
drop
constraint STM_GRT_FK_TERM;

alter table STM_GRPTER
drop
constraint STM_GRT_FK_TER;

alter table STM_PARAMAPP
drop
constraint STM_PAP_FK_APP;

alter table STM_PARAMSER
drop
constraint STM_PSE_FK_SER;

alter table STM_PARAMTTA
drop
constraint STM_PTT_FK_TAR;

alter table STM_ROLGCA
drop
constraint STM_RGC_FK_GCA;

alter table STM_ROLGCA
drop
constraint STM_RGC_FK_ROL;

alter table STM_ROLTAR
drop
constraint STM_RTA_FK_T;

alter table STM_ROLTAR
drop
constraint STM_RTA_FK_ROL;

alter table STM_SERVICIO
drop
constraint STM_SER_FK_CON;

alter table STM_TAREA
drop
constraint STM_TAR_FK_CON;

alter table STM_TAREA
drop
constraint STM_TAR_FK_GTA;

alter table STM_TAREA
drop
constraint STM_TAR_FK_TTA;

alter table STM_TAREA
drop
constraint STM_TAR_FK_TUI;

alter table STM_USUCONF
drop
constraint STM_UCF_FK_ROL;

alter table STM_USUCONF
drop
constraint STM_UCF_FK_TER;

alter table STM_USUCONF
drop
constraint STM_UCF_FK_USU;
...
(
  ...
  APP_HEADERPARAMS text default '{"headerLeftSection":{"logoSitmun":{"visible":true},"logoMenorca":{"alt":"","url":"","visible":false}},"headerRightSection":{"switchApplication":{"visible":true},"homeMenu":{"visible":true},"switchLanguage":{"visible":true},"profileButton":{"visible":true},"logoutButton":{"visible":true},"logoX":{"alt":"","url":"","visible":false},"logoY":{"alt":"","url":"","visible":false}}}',
