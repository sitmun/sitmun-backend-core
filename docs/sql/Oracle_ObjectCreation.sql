...
ALTER TABLE STM_PAR_TSK
    ADD CONSTRAINT STM_PTT_PK PRIMARY KEY (PTT_ID) USING INDEX TABLESPACE STM3_NDX;
...
ALTER TABLE STM_DOWNLOAD
    ADD CONSTRAINT STM_DOW_PK PRIMARY KEY (DOW_ID) USING INDEX TABLESPACE STM3_NDX;
...
ALTER TABLE STM_QUERY
    ADD CONSTRAINT STM_QUE_PK PRIMARY KEY (QUE_ID) USING INDEX TABLESPACE STM3_NDX;
...
ALTER TABLE STM_THEMATIC
    ADD CONSTRAINT STM_THE_PK PRIMARY KEY (THE_ID) USING INDEX TABLESPACE STM3_NDX;
...
ALTER TABLE STM_THE_RANK
    ADD CONSTRAINT STM_TRK_PK PRIMARY KEY (TRK_THEID, TRK_POSITION) USING INDEX TABLESPACE STM3_NDX;
