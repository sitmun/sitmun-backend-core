...
PROMPT
Creando Primary Key on 'STM_PAR_TSK'
...
PROMPT
Creando Primary Key on 'STM_DOWNLOAD'
...
PROMPT
Creando Primary Key on 'STM_QUERY'
...
PROMPT
Creando Primary Key on 'STM_THEMATIC'
...
PROMPT
Creando Primary Key on 'STM_THE_RANK'
...
PROMPT
Creando Foreign Key on 'STM_DOWNLOAD'
ALTER TABLE STM_DOWNLOAD
  ADD CONSTRAINT
    STM_DOW_FK_TAS FOREIGN KEY (DOW_ID) REFERENCES STM_TASK (TAS_ID);

PROMPT
Creando Foreign Key on 'STM_QUERY'
ALTER TABLE STM_QUERY
  ADD CONSTRAINT
...
PROMPT
Creando Foreign Key on 'STM_PAR_TSK'
ALTER TABLE STM_PAR_TSK
  ADD CONSTRAINT
...
PROMPT
Creando Foreign Key on 'STM_THEMATIC'
ALTER TABLE STM_THEMATIC
  ADD CONSTRAINT
...
PROMPT
Creando Foreign Key on 'STM_THE_RANK'
ALTER TABLE STM_THE_RANK
  ADD CONSTRAINT
