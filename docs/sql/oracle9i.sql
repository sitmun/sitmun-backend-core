...
CREATE TABLE STM_APP (
  ...
  APP_UNAVAILABLE NUMBER(1) DEFAULT 0 NOT NULL CHECK (APP_UNAVAILABLE IN (0, 1)),
  APP_LAST_UPDATE DATE,
  APP_CREATOR_ID NUMBER(11),
  APP_DESCRIPTION VARCHAR2(250),
  APP_PRIVATE   NUMBER(1) DEFAULT 0 NOT NULL CHECK (APP_PRIVATE IN (0, 1)),
