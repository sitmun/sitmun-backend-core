...
CREATE TABLE STM_APP (
  ...
  APP_TYPE      VARCHAR(250),
  APP_TITLE     VARCHAR(250),
  APP_THEME     VARCHAR(30),
  APP_SCALES    VARCHAR(250),
  APP_PROJECT   VARCHAR(250),
  APP_TEMPLATE  VARCHAR(250),
  APP_REFRESH   INT CHECK (APP_REFRESH IN (0, 1)),
  APP_ENTRYS    INT CHECK (APP_ENTRYS IN (0, 1)),
  APP_ENTRYM    INT CHECK (APP_ENTRYM IN (0, 1)),
  APP_GGIID     BIGINT,
  APP_CREATED   TIMESTAMP,
  APP_LOGO      VARCHAR(4000),
  APP_MAINTENANCE_INFORMATION VARCHAR(80),
  APP_UNAVAILABLE BOOLEAN DEFAULT FALSE NOT NULL,
  APP_LAST_UPDATE TIMESTAMP,
  APP_CREATOR_ID BIGINT,
