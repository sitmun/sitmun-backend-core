...
public class URIConstants {
  ...
  public static final String APPLICATION_PARAMETERS_URI_FILTERED =
      APPLICATION_URI + "/parameters?{1}={2}";
  ...
  public static final String BACKGROUNDS_URI = "http://localhost/api/backgrounds";
  ...
  public static final String BACKGROUND_URI_CARTOGRAPHY_GROUP =
      BACKGROUND_URI + "/cartographyGroup";

  public static final String BACKGROUND_URI_CARTOGRAPHY_GROUP_PROJECTION =
      BACKGROUND_URI_CARTOGRAPHY_GROUP + "?projection=view";

  public static final String CARTOGRAPHIES_URI = "http://localhost/api/cartographies";

  public static final String CARTOGRAPHIES_AVAILABLE_URI =
      CARTOGRAPHIES_URI + "/search/available?applicationId={0}";
  ...
  public static final String CARTOGRAPHY_URI_PERMISSION_URI_PROJECTION =
      CARTOGRAPHY_URI_PERMISSION_URI + "?projection=view";

  public static final String CARTOGRAPHY_PERMISSIONS_URI =
      "http://localhost/api/cartography-groups";

  public static final String CARTOGRAPHY_PERMISSION_URI = CARTOGRAPHY_PERMISSIONS_URI + "/{0}";
  ...
  public static final String CONFIGURATION_PARAMETERS_URI =
      "http://localhost/api/configuration-parameters";

  public static final String CONNECTIONS_URI = "http://localhost/api/connections";
  ...
  public static final String TASKS_AVAILABLE_URI =
      TASKS_URI + "/search/available?applicationId={0}";
  ...
  public static final String TERRITORY_PROJECTION_VIEW = "/api/territories/{0}?projection=view";

  public static final String TERRITORY_GROUP_TYPES_URI =
      "http://localhost/api/territory-group-types";
  ...
  public static final String WORKSPACE_APPLICATION_URI =
  ...
  public static final String CONFIG_CLIENT_APPLICATION_TERRITORIES_URI =
      CONFIG_CLIENT_APPLICATION_URI + "/{0}/territories";

  public static final String CONFIG_CLIENT_TERRITORY_URI = CONFIG_CLIENT_URI + "/territory";

  public static final String CONFIG_CLIENT_TERRITORY_APPLICATIONS_URI =
      CONFIG_CLIENT_TERRITORY_URI + "/{0}/applications";

  public static final String CONFIG_CLIENT_PROFILE_URI = CONFIG_CLIENT_URI + "/profile/{0}/{1}";

  public static final String CONFIG_CLIENT_PROFILE_URI_FILTERED =
      CONFIG_CLIENT_PROFILE_URI + "?filter={0}";
  ...
  public static final String TASK_PROJECTION_CARTOGRAPHY_VIEW =
      TASKS_URI + "/{0}/cartography?projection=view";
