...
class TemplateContextNormalizerTest {
  ...
  void keepsAlreadyNormalizedRows() {
    Map<String, Object> context =
        Map.of("FilteredHits", Map.of("rows", List.of(Map.of("Player", "Ichiro", "Hits", 262))));

    Map<String, Object> normalized = normalizer.normalize(context);

    assertThat(normalized).containsKey("FilteredHits");
  ...
  void normalizesFlattenedItemsRowsToObjectRows() {
    ...
    assertThat(rows)
        .containsExactly(
            Map.of("Player", "Ichiro", "Hits", 262), Map.of("Player", "Sisler", "Hits", 257));
    ...
    assertThat(rows.get(0))
        .isEqualTo(
            Map.of(
                ...
                "variants",
                    List.of(Map.of("name", "Small", "prices", List.of(Map.of("amount", 2.5))))));
  ...
  void copiesItemsArrayToRowsWhenRowsMissing() {
    Map<String, Object> normalized =
        normalizer.normalize(
            Map.of("Alias", Map.of("items", List.of(Map.of("name", "A"), Map.of("name", "B")))));
        ...
        normalizer.normalize(
            Map.of(
                ...
                Map.of(
                    ...
                    "Manual value",
                    "rows",
                    List.of(Map.of("Player", "Ichiro", "Hits", 262)))));
