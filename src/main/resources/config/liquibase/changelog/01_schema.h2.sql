...
ALTER TABLE STM_USR_CONF
    ADD CONSTRAINT STM_UCO_UK UNIQUE (UCO_USERID, UCO_TERID, UCO_ROLEID, UCO_ROLEMID);
...
ALTER TABLE STM_USR_CONF
    ADD CONSTRAINT STM_UCO_FK_USE FOREIGN KEY (UCO_USERID) REFERENCES STM_USER (USE_ID);
ALTER TABLE STM_USR_CONF
    ADD CONSTRAINT STM_UCO_FK_TER FOREIGN KEY (UCO_TERID) REFERENCES STM_TERRITORY (TER_ID);
ALTER TABLE STM_USR_CONF
    ADD CONSTRAINT STM_UCO_FK_ROL FOREIGN KEY (UCO_ROLEID) REFERENCES STM_ROLE (ROL_ID);
ALTER TABLE STM_USR_CONF
    ADD CONSTRAINT STM_UCO_FK_ROLM FOREIGN KEY (UCO_ROLEMID) REFERENCES STM_ROLE (ROL_ID);

ALTER TABLE STM_AVAIL_TSK
    ADD CONSTRAINT STM_ATS_FK_TER FOREIGN KEY (ATS_TERID) REFERENCES STM_TERRITORY (TER_ID);
ALTER TABLE STM_AVAIL_TSK
    ADD CONSTRAINT STM_ATS_FK_TAS FOREIGN KEY (ATS_TASKID) REFERENCES STM_TASK (TAS_ID);

ALTER TABLE STM_AVAIL_GI
    ADD CONSTRAINT STM_AGI_FK_TER FOREIGN KEY (AGI_TERID) REFERENCES STM_TERRITORY (TER_ID);
ALTER TABLE STM_AVAIL_GI
    ADD CONSTRAINT STM_AGI_FK_GEO FOREIGN KEY (AGI_GIID) REFERENCES STM_GEOINFO (GEO_ID);
...
ALTER TABLE STM_TREE_NOD
    ADD CONSTRAINT STM_TNO_FK_TRE FOREIGN KEY (TNO_TREEID) REFERENCES STM_TREE (TRE_ID);

ALTER TABLE STM_PAR_SER
    ADD CONSTRAINT STM_PSE_FK_SER FOREIGN KEY (PSE_SERID) REFERENCES STM_SERVICE (SER_ID);

ALTER TABLE STM_TREE_ROL
    ADD CONSTRAINT STM_TRO_FK_TRE FOREIGN KEY (TRO_TREEID) REFERENCES STM_TREE (TRE_ID);
ALTER TABLE STM_TREE_ROL
    ADD CONSTRAINT STM_TRO_FK_ROL FOREIGN KEY (TRO_ROLEID) REFERENCES STM_ROLE (ROL_ID);
...
ALTER TABLE STM_DOWNLOAD
    ADD CONSTRAINT STM_DOW_FK_TAS FOREIGN KEY (DOW_ID) REFERENCES STM_TASK (TAS_ID);

ALTER TABLE STM_QUERY
    ADD CONSTRAINT STM_QUE_FK_TAS FOREIGN KEY (QUE_ID) REFERENCES STM_TASK (TAS_ID);
ALTER TABLE STM_QUERY
...
ALTER TABLE STM_PAR_GI
    ADD CONSTRAINT STM_PGI_FK_GEO FOREIGN KEY (PGI_GIID) REFERENCES STM_GEOINFO (GEO_ID);

ALTER TABLE STM_ROL_GGI
    ADD CONSTRAINT STM_RGG_FK_ROL FOREIGN KEY (RGG_ROLEID) REFERENCES STM_ROLE (ROL_ID);
ALTER TABLE STM_ROL_GGI
    ADD CONSTRAINT STM_RGG_FK_GGI FOREIGN KEY (RGG_GGIID) REFERENCES STM_GRP_GI (GGI_ID);

ALTER TABLE STM_APP
    ADD CONSTRAINT STM_APP_FK_GGI FOREIGN KEY (APP_GGIID) REFERENCES STM_GRP_GI (GGI_ID);

ALTER TABLE STM_PAR_APP
    ADD CONSTRAINT STM_PAP_FK_APP FOREIGN KEY (PAP_APPID) REFERENCES STM_APP (APP_ID);

ALTER TABLE STM_BACKGRD
    ADD CONSTRAINT STM_BAC_FK_GGI FOREIGN KEY (BAC_GGIID) REFERENCES STM_GRP_GI (GGI_ID);

ALTER TABLE STM_APP_BCKG
    ADD CONSTRAINT STM_ABC_FK_APP FOREIGN KEY (ABC_APPID) REFERENCES STM_APP (APP_ID);
ALTER TABLE STM_APP_BCKG
    ADD CONSTRAINT STM_ABC_FK_FON FOREIGN KEY (ABC_BACKID) REFERENCES STM_BACKGRD (BAC_ID);

ALTER TABLE STM_APP_TREE
    ADD CONSTRAINT STM_ATR_FK_APP FOREIGN KEY (ATR_APPID) REFERENCES STM_APP (APP_ID);
ALTER TABLE STM_APP_TREE
    ADD CONSTRAINT STM_ATR_FK_TRE FOREIGN KEY (ATR_TREEID) REFERENCES STM_TREE (TRE_ID);

ALTER TABLE STM_APP_ROL
    ADD CONSTRAINT STM_ARO_FK_APP FOREIGN KEY (ARO_APPID) REFERENCES STM_APP (APP_ID);
ALTER TABLE STM_APP_ROL
    ADD CONSTRAINT STM_ARO_FK_ROL FOREIGN KEY (ARO_ROLEID) REFERENCES STM_ROLE (ROL_ID);

ALTER TABLE STM_PAR_TSK
    ADD CONSTRAINT STM_PTT_FK_TAS FOREIGN KEY (PTT_TASKID) REFERENCES STM_TASK (TAS_ID);

ALTER TABLE STM_ROL_TSK
    ADD CONSTRAINT STM_RTS_FK_ROL FOREIGN KEY (RTS_ROLEID) REFERENCES STM_ROLE (ROL_ID);
ALTER TABLE STM_ROL_TSK
    ADD CONSTRAINT STM_RTS_FK_TAS FOREIGN KEY (RTS_TASKID) REFERENCES STM_TASK (TAS_ID);

ALTER TABLE STM_FIL_GI
    ADD CONSTRAINT STM_FGI_FK_GEO FOREIGN KEY (FGI_GIID) REFERENCES STM_GEOINFO (GEO_ID);
ALTER TABLE STM_FIL_GI
...
ALTER TABLE STM_GGI_GI
    ADD CONSTRAINT STM_GGG_FK_GGI FOREIGN KEY (GGG_GGIID) REFERENCES STM_GRP_GI (GGI_ID);
ALTER TABLE STM_GGI_GI
    ADD CONSTRAINT STM_GGG_FK_GEO FOREIGN KEY (GGG_GIID) REFERENCES STM_GEOINFO (GEO_ID);
...
ALTER TABLE STM_GRP_TER
    ADD CONSTRAINT STM_GTE_FK_TER FOREIGN KEY (GTE_TERID) REFERENCES STM_TERRITORY (TER_ID);
ALTER TABLE STM_GRP_TER
    ADD CONSTRAINT STM_GTE_FK_TERM FOREIGN KEY (GTE_TERMID) REFERENCES STM_TERRITORY (TER_ID);

ALTER TABLE STM_POST
    ADD CONSTRAINT STM_POS_FK_USE FOREIGN KEY (POS_USERID) REFERENCES STM_USER (USE_ID);
ALTER TABLE STM_POST
    ADD CONSTRAINT STM_POS_FK_TER FOREIGN KEY (POS_TERID) REFERENCES STM_TERRITORY (TER_ID);
...
ALTER TABLE STM_THEMATIC
    ADD CONSTRAINT STM_THE_FK_TAS FOREIGN KEY (THE_TASKID) REFERENCES STM_TASK (TAS_ID);

ALTER TABLE STM_THE_RANK
    ADD CONSTRAINT STM_TRK_FK_THE FOREIGN KEY (TRK_THEID) REFERENCES STM_THEMATIC (THE_ID);
