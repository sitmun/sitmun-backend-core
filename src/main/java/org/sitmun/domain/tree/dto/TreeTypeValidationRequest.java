 ...
 *
 * <p>This endpoint accepts the intended final state (new type + candidate application IDs)
...
public class TreeTypeValidationRequest {
   ...
   * If null, defaults to an empty set (no applications).
   */
  @Builder.Default
  private Set<Integer> applicationIds = Set.of();
}
