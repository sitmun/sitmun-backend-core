...
@Table(
    ...
    uniqueConstraints =
        @UniqueConstraint(
            name = "STM_UCF_UK",
            columnNames = {"UCO_USERID", "UCO_TERID", "UCO_ROLEID", "UCO_ROLEM"}))
@Builder
@Getter
@Setter
@NoArgsConstructor
...
public class UserConfiguration {
  ...
  /**
   * Role applies to children territories in case the user can access the territory through its
   * children.
   *
   * <p>This role only applies when {@link Application#getAccessChildrenTerritory()} is {@code
   * true}.
   */
