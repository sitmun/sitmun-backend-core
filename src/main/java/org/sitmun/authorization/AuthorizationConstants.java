package org.sitmun.authorization;

/**
 * Constants used for authorization-related operations in SITMUN.
 * This class provides a collection of constant values used throughout the authorization system.
 */
public class AuthorizationConstants {
  ...
  /**
   * Constants related to Task DTO operations.
   * Contains parameter names and values used in task-related operations.
   */
