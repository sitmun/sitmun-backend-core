...
/**
 * Configuration for LDAP health indicator.
 * Only enabled when the 'ldap' profile is active and LDAP health checks are enabled.
 */
@Configuration
@Profile("ldap")
public class LdapHealthIndicatorConfig {
    ...
    /**
     * Configures the LDAP health indicator to be enabled only when:
     * 1. The 'ldap' profile is active
