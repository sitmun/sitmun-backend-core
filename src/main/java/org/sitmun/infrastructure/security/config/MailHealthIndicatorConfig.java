...
/**
 * Configuration for mail health indicator.
 * Only enabled when the 'mail' profile is active and mail health checks are enabled.
 */
@Configuration
@Profile("mail")
public class MailHealthIndicatorConfig {
    ...
    /**
     * Configures the mail health indicator to be enabled only when:
     * 1. The 'mail' profile is active
