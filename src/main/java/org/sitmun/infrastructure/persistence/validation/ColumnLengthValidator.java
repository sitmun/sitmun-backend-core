...
/**
 * A Spring Validator that automatically truncates string fields to their maximum length
 * as defined by {@code @Column(length)} annotation.
 * <p>
 * This validator performs two main operations:
 * <ol>
 *     <li>Validates the target object using standard validators through {@code LocalValidatorFactoryBean}.</li>
 *     <li>Truncates any string fields that exceed their {@code @Column(length}) constraint.</li>
 * </ol>
 */
@Component
@Slf4j
public class ColumnLengthValidator implements Validator {
    ...
    /**
     * Indicates whether this validator supports validation of the given class.
     ...
     * <ol>
     *     <li>Running standard validations through the validator factory</li>
     *     <li>Truncating any string fields that exceed their {@code @Column(length)} constraint</li>
     * </ol>
     *
    ...
    public void validate(@NotNull Object target, @NotNull Errors errors) {
        ...
        for (PropertyDescriptor descriptor : propertyDescriptors) {
            if (String.class.equals(descriptor.getPropertyType())) {
                ...
                getField(target.getClass(), propertyName).ifPresent(getFieldConsumer(beanWrapper, propertyName));
            }
        }
    }
        ...
        return field -> {
            ...
            if (lob == null && column != null && column.length() > 0) {
                ...
                if (value != null && value.length() > column.length()) {
                    ...
                    log.info("Truncated field {} from {} to {} characters",
                            propertyName, value.length(), column.length());
                }
            }
        };
    }
