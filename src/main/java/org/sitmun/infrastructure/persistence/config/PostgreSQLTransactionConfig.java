 ...
 *
 * <p>This configuration handles PostgreSQL transaction management and auto-commit issues. It's
 * automatically activated when using the 'postgres' profile.
 */
@Configuration
@Profile("postgres")
...
public class PostgreSQLTransactionConfig {
  ...
  /**
   * Configure transaction management for PostgreSQL. This method is called after the application
