...
public class DatabaseConnectionTesterService {
  ...
  public Boolean testDriver(@NotNull DatabaseConnection connection)
      throws DatabaseConnectionDriverNotFoundException {
    ...
    try {
      ...
      log.error(
          "Driver not found for DatabaseConnection({}) with driver {}", id, driver, exception);
  ...
  public Boolean testConnection(@NotNull DatabaseConnection connection) throws Exception {
    ...
    try {
      ...
      log.error(
          "GetConnection throws exception for DatabaseConnection({}) with url \"{}\"",
          id,
          url,
          exception);
      error = exception;
      ...
      if (con != null) {
        try {
          ...
          log.error(
              "Close throws exception for DatabaseConnection({}) with url \"{}\"",
              id,
              url,
              exception);
          error = exception;
